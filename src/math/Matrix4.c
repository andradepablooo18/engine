...
Matrix4 Matrix4_rotation_x(f32 angle) {
    Matrix4 m4 = {{{1, 0, 0, 0},
...
Matrix4 Matrix4_rotation_y(f32 angle) {
    Matrix4 m4 = {{{cos(angle), 0, sin(angle), 0},
                   {0, 1, 0, 0},
...
Matrix4 Matrix4_rotation_z(f32 angle) {
    Matrix4 m4 = {{{cos(angle), -sin(angle), 0, 0},
